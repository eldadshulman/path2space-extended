...
\* The published trastuzumab pipeline applies a `1 - x` flip to the
ERBB2 score at test time only (not during CV). That asymmetry pulls
down the IMPRESS ERBB2 and combined AUCs; reproduced here for fidelity.
