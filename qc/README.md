...
- `notebooks/01_qc_example.ipynb` — worked example computing all six metrics on one ST section (NCBI776, a breast-cancer Visium section from the public [HEST-1k](https://huggingface.co/datasets/MahmoodLab/hest) dataset).
